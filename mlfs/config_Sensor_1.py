...
class HopsworksSettings(BaseSettings):
    ...
    AQICN_STREET_Sensor_1: str | None = None
    AQICN_URL_Sensor_1: str | None = None
    ...
    def model_post_init(self, __context):
        ...
        # 5. AQICN_STREET
        aqicn_street_Sensor_1 = self.AQICN_STREET_Sensor_1 or os.getenv("AQICN_STREET_Sensor_1")
        if not aqicn_street_Sensor_1:
            missing.append("AQICN_STREET_Sensor_1")
        # 6. AQICN_URL
        aqicn_url_Sensor_1 = self.AQICN_URL_Sensor_1 or os.getenv("AQICN_URL_Sensor_1")
        if not aqicn_url_Sensor_1:
            missing.append("AQICN_URL_Sensor_1")
