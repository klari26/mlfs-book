...
class HopsworksSettings(BaseSettings):
    ...
    AQICN_STREET_Sensor_3: str | None = None
    AQICN_URL_Sensor_3: str | None = None
    ...
    def model_post_init(self, __context):
        ...
        # 5. AQICN_STREET
        aqicn_street_Sensor_3 = self.AQICN_STREET_Sensor_3 or os.getenv("AQICN_STREET_Sensor_3")
        if not aqicn_street_Sensor_3:
            missing.append("AQICN_STREET_Sensor_3")
        # 6. AQICN_URL
        aqicn_url_Sensor_3 = self.AQICN_URL_Sensor_3 or os.getenv("AQICN_URL_Sensor_3")
        if not aqicn_url_Sensor_3:
            missing.append("AQICN_URL_Sensor_3")
